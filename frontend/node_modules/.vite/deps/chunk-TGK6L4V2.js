...
var AppKit = class extends AppKitBaseClient {
  ...
  async loadModalComponents(features, remoteFeatures) {
    ...
    if (usingEmbeddedWallet) {
      featureImportPromises.push(import("./embedded-wallet-LQXM262M.js"));
    }
    if (remoteFeatures.email) {
      featureImportPromises.push(import("./email-J4VU2H7C.js"));
    }
    if (remoteFeatures.socials) {
      featureImportPromises.push(import("./socials-AFQAFM55.js"));
    }
    if (remoteFeatures.swaps && remoteFeatures.swaps.length > 0) {
      featureImportPromises.push(import("./swaps-I2GUB6KI.js"));
    }
    if (features.send) {
      featureImportPromises.push(import("./send-EPVBHVDL.js"));
    }
    if (features.receive) {
      featureImportPromises.push(import("./receive-4HOUCELQ.js"));
    }
    if (remoteFeatures.onramp && remoteFeatures.onramp.length > 0) {
      featureImportPromises.push(import("./onramp-Z3CXLOVR.js"));
    }
    if (remoteFeatures.activity) {
      featureImportPromises.push(import("./transactions-67R5ZXIK.js"));
    }
    if (features.pay) {
      featureImportPromises.push(import("./exports-2TK5RS5X.js"));
    }
    if (remoteFeatures.emailCapture) {
      featureImportPromises.push(import("./ui-TRHDXMNY.js"));
    }
    await Promise.all([
      ...featureImportPromises,
      import("./exports-P5A2ZLWI.js"),
      import("./w3m-modal-UYQ4W4IU.js")
    ]);
  }
};
...
//# sourceMappingURL=chunk-TGK6L4V2.js.map
