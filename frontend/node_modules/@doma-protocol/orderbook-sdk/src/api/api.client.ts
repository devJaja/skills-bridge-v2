...
import type {
  ...
  CreateBulkListingResponse,
  CreateBulkOfferRequest,
  CreateBulkOfferResponse,
} from './types';
...
export class ApiClient {
  ...
  public async createBulkListing(
    params: CreateBulkListingRequest,
    options?: RequestOptions,
  ): Promise<CreateBulkListingResponse> {
    return this.makeRequest<CreateBulkListingRequest, CreateBulkListingResponse>(
  ...
  public async createBulkOffer(
    params: CreateBulkOfferRequest,
    options?: RequestOptions,
  ): Promise<CreateBulkOfferResponse> {
    return this.makeRequest<CreateBulkOfferRequest, CreateBulkOfferResponse>(
