...
export class DomaOrderbookSDK {
  ...
  private validateSignerAndChainProvided(signer: JsonRpcSigner, chainId: Caip2ChainId) {
    if (!signer) {
  ...
  public async getOrderbookFee(params: GetOrderbookFeeRequest): Promise<GetOrderbookFeeResponse> {
...
export const createDomaOrderbookClient = (config: DomaOrderbookSDKConfig): DomaOrderbookSDK => {
