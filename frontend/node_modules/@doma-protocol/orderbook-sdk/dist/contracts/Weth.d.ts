...
export declare namespace ApprovalEvent {
    type InputTuple = [src: AddressLike, guy: AddressLike, wad: BigNumberish];
...
export declare namespace TransferEvent {
    type InputTuple = [src: AddressLike, dst: AddressLike, wad: BigNumberish];
...
export interface Weth extends BaseContract {
    ...
    getFunction(nameOrSignature: 'approve'): TypedContractMethod<[guy: AddressLike, wad: BigNumberish], [boolean], 'nonpayable'>;
    ...
    getFunction(nameOrSignature: 'transfer'): TypedContractMethod<[dst: AddressLike, wad: BigNumberish], [boolean], 'nonpayable'>;
    getFunction(nameOrSignature: 'deposit'): TypedContractMethod<[], [void], 'payable'>;
    getFunction(nameOrSignature: 'allowance'): TypedContractMethod<[arg0: AddressLike, arg1: AddressLike], [bigint], 'view'>;
